...
class CommitsPage extends Component {
    ...
    componentDidMount(){
        this.props.getCommits(Services.getUsername(),Services.getPassword(),this.props.data.name)
...
const mapDispatchToProps = dispatch => {
    return ({
        getCommits(username, password, name) { getCommits(dispatch, username, password, name) },
    })
}

const mapStateToProps = ({  commitLib }) => {
    console.log("...state", commitLib)
    const {commitSuccessData,commitFailureData,commitType} = commitLib
    return {commitSuccessData,commitFailureData,commitType}
