    ...
    render() {
        return (
            <View style={{flex: 1}}>
                <View style={styles.header}>
                    <Image source={require('../../../img/header_background.png')} style={styles.headerImage}>
                        ...
                        <View style={styles.headerTextView}>
                            <Text style={styles.headerText}>Repo Page</Text>
                        </View>
                ...
                <View>
                    <TouchableOpacity onPress = {() => Actions.RepoCodePage({data:this.props.data})} style = {styles.mainButton}>
                        <Text style = {styles.mainButtonText}>Code</Text>
                    </TouchableOpacity>
                </View>
                <View>
                    <TouchableOpacity onPress = {() => Actions.Issues({data:this.props.data})} style = {styles.mainButton}>
                        <Text style = {styles.mainButtonText}>Issues</Text>
                    </TouchableOpacity>
                </View>
                <View>
                    <TouchableOpacity onPress = {() => Actions.Repos()} style = {styles.mainButton}>
                        <Text style = {styles.mainButtonText}>Pull Requests</Text>
                    </TouchableOpacity>
                </View>
                <View>
                    <TouchableOpacity onPress = {() => Actions.Repos()} style = {styles.mainButton}>
                        <Text style = {styles.mainButtonText}>Projects</Text>
                    </TouchableOpacity>
                </View>
                <View>
                    <TouchableOpacity onPress = {() => Actions.Repos()} style = {styles.mainButton}>
