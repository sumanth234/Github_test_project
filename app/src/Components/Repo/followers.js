        ...
        return (
            <View style={{flex: 1}}>
                <View style={styles.header}>
                    <Image source={require('../../../img/header_background.png')} style={styles.headerImage}>
                        ...
                        <View style={styles.headerTextView}>
                            <Text style={styles.headerText}>My Followers</Text>
                        </View>
                ...
                {this.props.followerType?
                    ...
                    :
                    <ScrollView >
                        { _.map(this.props.followerSuccessData,(rowData) => {
                            return(
                                <TouchableOpacity style={styles.mainButton} onPress = {() =>{
                                    ...
                                    <View>
                                        <Text style={{fontSize:18,fontWeight:'bold'}}>{rowData.login}{" is following you"}</Text>
...
const mapStateToProps = ({  followerLib }) => {
    console.log("...state", followerLib)
    const {followerSuccessData,followerFailureData,followerType} = followerLib
    return {followerSuccessData,followerFailureData,followerType}
